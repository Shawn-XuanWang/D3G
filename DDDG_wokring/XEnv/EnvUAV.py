...
class UAV_formation():
    ...
    def initCost(self, w_F_r=None, w_F_v=None, w_r_formation=None,
        ...
        for uav_index in range(self.uav_num):
            ...
            # if uav_index == 0:
            #     self.cost_r_formation[uav_index] = norm_2(self.r_I[uav_index] - self.r_I[3] - vcat([2, 0, 0]))
            ...
            self.cost_r_I[uav_index] = norm_2(r_I[uav_index] - goal_r_I - vcat([self.uav_dist[uav_index], 0, 0]))
